...
Anomaly detection vs injected ground truth
  transactions 1033   injected 50   flagged 52
...
The script asserts thresholds and exits non-zero below them, so a regression
fails CI instead of printing a worse number into a log.
